...
const post_create_form = document.getElementById("post_create_form");
const post_update_form = document.getElementById("post_update_form");
const post_form_hide = document.getElementById("post_Create_btn");
const post_update_form_hide = document.getElementById("post_update_btn");
const msg = document.querySelector(".msg");
const user_post = document.querySelector(".user-post-wrapper");
const delectBtn = document.querySelectorAll(".post-dropdown-menu ul:last-child");


    document.addEventListener("DOMContentLoaded", () => {
      // Get all post menus and dropdown menus
      const postMenus = document.querySelectorAll(".post-menu");
      const dropdownMenus = document.querySelectorAll(".post-dropdown-menu");

      // Iterate over each post menu button and attach event listener
      postMenus.forEach((postMenu, index) => {
...
// Get all posts and show on timeline
const getAllPosts = () => {
                  ...
                  <div class="user-details">
                    ...
                    <span>10m
                      <svg fill="currentColor" viewBox="0 0 16 16" width="1em" height="1em"
                        class="x1lliihq x1k90msu x2h7rmj x1qfuztq xcza8v6 x1kpxq89 xsmyaan" title="Shared with Public">
                ...
                <div class="post-menu">
                  <div class="post-dropdown-menu">
                    <ul>
                      ...
                      <li data-bs-toggle="modal" data-bs-target="#post_update" onclick="modalEdit('${item.id}')">
                        <a href="#">
                          <div class="menu-icon"></div>
                          <span>Edit post</span>
                        </a>
...
// Form submit
post_create_form.onsubmit = (event) =>{
    ...
    let ls_data = [];
    if(!name || !photo){
        msg.innerHTML = createAlert("Author name and Author photo are required!");
    }else{
        if(old_data){
